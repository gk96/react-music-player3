...
router.post("/download-video-parts", async (req, res) => {
...
router.post("/download-video-ytdl-player1", async (req, res) => {
  console.log(req.body.videoUrl, "player1 - API")
...
router.get("/download-video-ytdl-player2", async (req, res) => {
...
router.post("/download-video-ytdl-player3", async (req, res) => {
  console.log(req.body.videoId, "player3 - API")

  // Remove 'user:pass@' if you don't need to authenticate to your proxy.
  // const proxy = 'http://s4ha89.deta.dev';
  // const agent = HttpsProxyAgent(proxy);

  // let info = await ytdl.getInfo(req.body.videoId, {requestOptions: {agent}});
  ...
  //     }
  res.send(format?.url)
  // console.log(ytdl.getInfo(req.body.videoUrl))
})

router.get("/download-video-ytdl-test", async (req, res) => {
...
router.post("/get-video-details", async (req, res) => {
